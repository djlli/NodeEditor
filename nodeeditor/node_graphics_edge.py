...
class QDMGraphicsEdge(QGraphicsPathItem):
    def __init__(self, edge, parent=None):
        ...
        self.posSource = [0, 0]
        self.posDesitnation = [100, 100]

    def setSource(self, x, y):
        self.posSource = [x, y]

    def setDesitination(self, x, y):
        self.posDesitnation = [x, y]
...
class QDMGraphicsEdgeDirect(QDMGraphicsEdge):
    def calcPath(self):
        ...
        path.lineTo(self.posDesitnation[0], self.posDesitnation[1])
        return path

class QDMGraphicsEdgeBezier(QDMGraphicsEdge):
    def calcPath(self):
        s = self.posSource
        d = self.posDesitnation
        dist = (d[0] - s[0]) * 0.5
        ...
        path = QPainterPath(QPointF(self.posSource[0], self.posSource[1]))
        path.cubicTo(s[0] + cpx_s, s[1] + cpy_s, d[0] + cpx_d, d[1] + cpy_d, self.posDesitnation[0], self.posDesitnation[1])
        return path
